...
and in the Octave compatibility function for \matl{X\textasciitilde{}} (\matlab+setxor+), the latter of which also affected other functions. Also for noticing a difference with \matlab+char+'s implicit rounding in MATLAB and in Octave.
% Zhttps://chat.stackexchange.com/transcript/message/41158178#41158178
\item
