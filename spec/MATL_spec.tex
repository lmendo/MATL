...
\item
\user{@Sanchises} for noticing a bug in the \matl{Za} (base conversion) function, as well as another in the Octave compatibility function for \matl{X\textasciitilde{}} (\matlab+setxor+), which also affected other functions.
\item
