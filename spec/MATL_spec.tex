...
\item
\user{@sundar} for prompting me to clarify that strings are understood as row vectors of chars in MATL, for several corrections in the documentation, and for suggestion using two-input char mode for function \matl{Yo}.
