...
in the Octave compatibility function for \matl{X\textasciitilde{}} (\matlab+setxor+), the latter of which also affected other functions, and for finding another problem in that function, which turned out to be caused by a weird Octave bug with vertical concatenation;
