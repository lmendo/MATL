...
Consequently, \matlab+vpa(str2sym(...), ...)+ is needed. On the other hand, Octave does not have \matlab+str2sym+, and allows char input to \matlab+vpa+. This is handled by the compiler by using \matlab+vpa(str2sym(...), ...)+ in the compiled code but defining \matlab+str2sym+ as the identity function in Octave. 
\item
