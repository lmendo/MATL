...
\matl{Y"} & 2-- (2 / 3) & 1 & \matlab+repelem+ (run-length decoding). With $2$ inputs: second input is linearized if needed. If the first input is shorter than the second the entries of the first input are repeated cyclically to match the length of the second \\
