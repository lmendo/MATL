...
\matl{Z\$} & 0--1 (0 / 1) & 1 & Reads bytes from specifed file. Each individual bytes is then converted to a char, and the output is a row vector of char. If $0$ inputs or empty input: file name is \comp{inout}. \\
