...
\matl{Y"} & 2-- (2 / 3) & 1 & \matlab+repelem+ (run-length decoding). With $2$ inputs: second input is linearized if needed. If the first or second input is shorter than the other, entries are repeated cyclically to match lengths \\
