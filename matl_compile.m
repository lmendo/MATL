...
% Set initial conditions and specify cleanup functions to restore initial conditions at the end of
% the program even if an error occurs.
appendLines('', 0)
...
if ~isMatlab
    ...
    fnames = {'num2str' 'im2col' 'spiral' 'unique' 'union' 'intersect' 'setdiff' 'setxor' 'ismember' ...
        ...
        'datestr' 'regexp' 'regexprep' 'imshow' 'mat2str' 'blkdiag' 'strcat' 'str2num'};
